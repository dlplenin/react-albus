...
var Wizard = function (_Component) {
  ...
  function Wizard() {
    ...
    }, _this.history = _this.props.history || (0, _history.createMemoryHistory)(), _this.steps = [], _this.init = function (steps) {
      _this.steps = steps;
    ...
    }, _this.push = function (step) {
      var nextStep = step || _this.paths[_this.paths.indexOf(_this.state.step.path) + 1];
      _this.history.push((0, _utils2.default)(_this.props.basename + '/' + nextStep));
    }, _this.replace = function (step) {
      var nextStep = step || _this.paths[0];
      _this.history.replace((0, _utils2.default)(_this.props.basename + '/' + nextStep));
    }, _this.next = function () {
      if (_this.props.onNext) {
  ...
  _createClass(Wizard, [{
    ...
    value: function componentWillMount() {
      ...
      this.unlisten = this.history.listen(function (_ref2) {
        ...
        var path = pathname.split('/').splice(2).join('/');
